...
public class ConfigFileManager {
    ...
    static StickerPack fromMethodCall(Context context, MethodCall call){
        ...
        StickerPack newStickerPack = new StickerPack(identifier, name, publisher, trayImageFileName, "", publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite, imageDataVersion, false);
